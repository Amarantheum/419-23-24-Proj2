...
,
		"rect" : [ -1309.0, 153.0, 786.0, 1065.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 561.0, 457.0, 34.0, 22.0 ],
					"style" : "",
					"text" : "write"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 600.5, 457.0, 33.5, 22.0 ],
					"style" : "",
					"text" : "read"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 600.5, 423.0, 36.0, 22.0 ],
					"style" : "",
					"text" : "sel 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 561.0, 423.0, 36.0, 22.0 ],
					"style" : "",
					"text" : "sel 0"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 586.0, 390.5, 16.0, 16.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 121.0, 122.0, 16.0, 16.0 ],
					"range" : 201,
					"threshold" : 0.94,
					"trackhorizontal" : 1,
					"tracking" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 561.0, 389.0, 16.0, 16.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 121.0, 138.0, 16.0, 16.0 ],
					"range" : 201,
					"threshold" : 0.94,
					"trackhorizontal" : 1,
					"tracking" : 1,
...
,
					"patching_rect" : [ 76.0, 599.0, 82.0, 22.0 ],
...
, 			{
				"box" : 				{
					"border" : 0,
					"embedstate" : [ [ "vreset", 0 ], [ "vmin", 0 ], [ "type", 1 ], [ "readout", 1 ], [ "frgb", 0, 0, 0, 1 ], [ "brgb", 1, 1, 1, 0 ], [ "fontsize", 10 ], [ "font", "Arial" ], [ "vmax", 200 ] ],
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 514.0, 580.0, 27.0, 47.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 52.0, 37.5, 27.0, 47.0 ],
					"varname" : "jsui[2]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 219.0, 543.5, 60.0, 22.0 ],
					"style" : "",
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 219.0, 575.5, 121.0, 22.0 ],
					"style" : "",
					"text" : "pattrstorage ringMod"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 219.0, 667.0, 58.0, 22.0 ],
					"restore" : 					{
						"jsui[2]" : [ 29 ],
						"pictslider" : [ 500, 0 ]
					}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 187.75, 732.0, 202.0, 22.0 ],
					"saved_object_attributes" : 					{
...
,
					"style" : "",
					"text" : "pattrstorage ringMod @savemode 0",
					"varname" : "ringMod"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 219.0, 609.5, 84.5, 30.0 ],
					"pattrstorage" : "ringMod",
					"presentation" : 1,
					"presentation_rect" : [ 139.0, 125.0, 80.0, 28.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 76.0, 545.0, 26.0, 17.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 11.5, 96.0, 25.0, 17.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 53.0, 422.0, 19.0, 70.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 14.5, 26.0, 19.0, 70.0 ],
					"rightmargin" : 3,
					"rightvalue" : 0,
					"style" : "",
					"topmargin" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 55.0, 684.0, 24.5, 104.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 7.5, 26.0, 24.5, 70.0 ],
					"proportion" : 0.39,
					"rounded" : 0,
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 679.0, 214.5, 32.0, 32.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 189.0, 23.0, 32.0, 32.0 ],
					"range" : 201,
					"threshold" : 0.94,
					"trackhorizontal" : 1,
					"tracking" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 681.0, 103.0, 147.0, 20.0 ],
					"style" : "",
					"text" : "nTbp_ #1 @name RING_MOD"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 641.0, 73.0, 135.0, 20.0 ],
					"style" : "",
					"text" : "MRrC #1 @r ringModPreset"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 587.0, 49.0, 165.0, 20.0 ],
					"style" : "",
					"text" : "MRrC #1 @r writeRingModPresets"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 548.0, 23.0, 163.0, 20.0 ],
					"style" : "",
					"text" : "MRrC #1 @r readRingModPresets"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 4,
					"numoutlets" : 0,
					"patching_rect" : [ 428.0, 23.0, 99.0, 20.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 346.0, 21.0, 73.0, 19.0 ],
					"style" : "",
					"text" : "r exRingModIn"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 314.0, 110.0, 74.0, 19.0 ],
					"style" : "",
					"text" : "s passRingMod"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 102.0, 25.0, 29.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 102.0, 5.0, 29.0, 18.0 ],
					"style" : "",
					"text" : "VOL"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 238.0, 58.0, 45.0, 19.0 ],
					"style" : "",
					"text" : "pcontrol"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 238.0, 36.0, 86.0, 19.0 ],
					"style" : "",
					"text" : "muter"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 383.0, 97.0, 50.0, 19.0 ],
					"style" : "",
					"text" : "pcontrol"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 383.0, 78.0, 27.0, 29.0 ],
					"style" : "",
					"text" : "open"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 238.0, 45.0, 28.0, 27.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 156.0, 24.0, 28.0, 27.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 649.0, 287.0, 20.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 197.0, 60.0, 20.0, 20.0 ],
					"range" : 201,
					"trackhorizontal" : 1,
					"tracking" : 1,
					"trackvertical" : 1
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 166.0, 368.0, 68.0, 16.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 47.0, 108.0, 68.0, 16.0 ],
					"rightmargin" : 1,
					"rightvalue" : 1000,
					"style" : "",
					"topmargin" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 180.0, 332.0, 45.0, 19.0 ],
					"style" : "",
					"text" : "* 1000."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 226.0, 445.0, 45.0, 19.0 ],
					"style" : "",
					"text" : "/ 1000."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 383.0, 121.0, 63.0, 19.0 ],
					"style" : "",
					"text" : "ringModInfo"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 157.0, 83.0, 42.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 155.0, 61.0, 42.0, 18.0 ],
					"style" : "",
					"text" : "CYCLE"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 6.0, 108.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 48.0, 34.0, 112.0, 26.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 52.0, 14.0, 112.0, 26.0 ],
					"style" : "",
					"text" : "RING_MOD"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 78.0, 63.0, 64.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 78.0, 43.0, 64.0, 18.0 ],
					"style" : "",
					"text" : "MOD FREQ"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 44.0, 143.0, 31.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 39.0, 123.0, 31.0, 18.0 ],
					"style" : "",
					"text" : "DRY"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 97.0, 142.0, 33.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 91.0, 122.0, 33.0, 18.0 ],
					"style" : "",
					"text" : "WET"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 171.0, 25.0, 54.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 171.0, 5.0, 54.0, 18.0 ],
					"style" : "",
					"text" : "ON / OFF"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 134.0, 126.0, 80.0, 13.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 136.0, 108.0, 83.0, 13.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 6,
					"outlettype" : [ "signal", "", "", "", "", "" ],
					"patching_rect" : [ 48.0, 105.0, 152.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 48.0, 86.0, 116.0, 19.0 ],
					"style" : "",
					"text" : "ringMod.maxpat #1",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 5.0, 24.0, 60.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 5.0, 4.0, 60.0, 18.0 ],
					"style" : "",
					"text" : "SIGNAL IN",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 4.0, 162.0, 72.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 4.0, 142.0, 72.0, 18.0 ],
					"style" : "",
					"text" : "SIGNAL OUT",
					"textcolor" : [ 0.4, 0.4, 0.8, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "jit_matrix" ],
					"patching_rect" : [ 204.0, 45.0, 30.0, 30.0 ],
					"pic" : "info.png",
					"presentation" : 1,
					"presentation_rect" : [ 155.0, 23.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 346.0, 815.0, 224.0, 160.0 ],
					"presentation" : 1,
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 468.5, 498.0, 197.25, 498.0 ],
					"source" : [ "obj-1", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 247.5, 103.0, 57.5, 103.0 ],
					"source" : [ "obj-11", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 314.5, 94.0, 168.333328, 94.0 ],
					"source" : [ "obj-12", 2 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 281.0, 88.0, 190.5, 88.0 ],
					"source" : [ "obj-12", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 690.5, 130.0, 535.0, 130.0, 535.0, 7.0, 57.5, 7.0 ],
					"source" : [ "obj-129", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 557.5, 144.0, 386.5, 144.0 ],
					"source" : [ "obj-130", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 228.5, 699.0, 202.0, 699.0, 202.0, 357.0, 175.5, 357.0 ],
					"source" : [ "obj-14", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 228.5, 699.0, 376.0, 699.0, 376.0, 569.0, 523.5, 569.0 ],
					"source" : [ "obj-14", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 610.0, 605.0, 197.25, 605.0 ],
					"source" : [ "obj-145", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 570.5, 605.0, 197.25, 605.0 ],
					"source" : [ "obj-146", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 246.0, 188.0, 335.0, 188.0, 335.0, 59.0, 392.5, 59.0 ],
					"source" : [ "obj-17", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 658.5, 317.0, 402.333344, 317.0, 402.333344, 94.0, 146.166672, 94.0 ],
					"source" : [ "obj-18", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 175.5, 414.5, 235.5, 414.5 ],
					"source" : [ "obj-19", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 189.5, 359.0, 175.5, 359.0 ],
					"source" : [ "obj-20", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 235.5, 474.0, 286.75, 474.0, 286.75, 94.0, 124.0, 94.0 ],
					"source" : [ "obj-21", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 386.5, 485.5, 197.25, 485.5 ],
					"source" : [ "obj-3", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 198.0, 124.75, 688.5, 124.75 ],
					"source" : [ "obj-33", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 64.5, 119.0, 40.0, 119.0, 40.0, 101.0, 101.833336, 101.0 ],
					"source" : [ "obj-4", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 163.899994, 205.0, 658.5, 205.0 ],
					"source" : [ "obj-40", 4 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 137.300003, 227.5, 189.5, 227.5 ],
					"source" : [ "obj-40", 3 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 57.5, 144.0, 143.5, 144.0 ],
					"source" : [ "obj-40", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 110.699997, 191.0, 1.0, 191.0, 1.0, 34.0, 64.5, 34.0 ],
					"source" : [ "obj-40", 2 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 84.099998, 351.5, 523.5, 351.5 ],
					"source" : [ "obj-40", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 190.5, 168.75, 688.5, 168.75 ],
					"source" : [ "obj-40", 5 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 596.5, 157.0, 468.5, 157.0 ],
					"source" : [ "obj-48", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 650.5, 350.75, 228.5, 350.75 ],
					"source" : [ "obj-51", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 355.5, 40.0, 64.5, 40.0 ],
					"source" : [ "obj-6", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 523.5, 637.0, 301.583344, 637.0, 301.583344, 94.0, 79.666664, 94.0 ],
					"source" : [ "obj-62", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 688.5, 256.5, 468.0, 256.5, 468.0, 25.0, 247.5, 25.0 ],
					"source" : [ "obj-67", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 116.0, 42.0, 64.5, 42.0 ],
					"source" : [ "obj-9", 0 ]
				}
...
, 			{
				"name" : "ringMod.maxpat",
				"bootpath" : "/Max/UBCToolbox/UBCToolbox_1.00/Modules/Effects/ringMod/lib",
